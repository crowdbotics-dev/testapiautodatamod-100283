...
## Project Structure
    ...
    ├── testapiautodatamod_100283  # Django project configurations
...
1. Clone this repo and `cd testapiautodatamod_100283`
...
2. Clone this repo and `cd testapiautodatamod_100283`
